...
export class TwoLevelTree {
    ...
    svgMaxWidth() {
        ...
        console.log('parentElementComputedStyle.paddingLeft');
        console.log(parentElementComputedStyle.paddingLeft);
        console.log('parentElementComputedStyle.paddingRight');
        console.log(parentElementComputedStyle.paddingRight);
    ...
    calculateLayout() {
        ...
        console.log('maxNumberOfNodes');
        console.log(maxNumberOfNodes);
        console.log('this.presentation.nodeR');
        console.log(this.presentation.nodeR);
        console.log('this.presentation.tooltipHeight');
        console.log(this.presentation.tooltipHeight);
